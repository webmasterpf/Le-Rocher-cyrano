...
$args_fl3 = $view->set_arguments(array(19));
...
if (!empty($view->result)) {
  ...
  $output = '<div id="services" class="bloc-pole"><h3 class="CLASS_NAME">'.$view->get_title().'</h3>' .$view->preview($viewdisplay_fl3,$args_fl3).'</div>';
