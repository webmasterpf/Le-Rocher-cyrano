...
function cyrano_lr_preprocess(&$vars, $hook)
{
  switch($hook)
  {
      case 'page' :
...
function cyrano_lr_preprocess_node(&$vars, $hook) {
...
function cyrano_lr_filefield_file($file) {
...
function cyrano_lr_more_link ($url, $title) {
